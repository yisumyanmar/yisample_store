                ...
                <div class="order_minute">
                    ...
                    <div class="order_z" v-for="(item,index) in orderData" :key="index">
                        <div class="order_number">
                            ...
                            <span class="black order_time">订单号: {{item.order_sn_id}} &nbsp;&nbsp;下单时间: <time-Plunge
                                    :timePlunge="item.create_time"></time-Plunge></span>
                        </div>
                        <ul>
                            <li v-for="(value, i) in goods" :key="i">
                                <div class="shop" v-if="value.id == item.id">
                                    ...
                                    <div v-if="value.goods_price != '0.00'" class="fl ping">{{value.goods_price}}</div>
